...
(defn get-block-at-position [ship position] (position (get-structure ship)))
...
(defn set-block-at-position [ship position block-name] (set-structure ship (assoc (get-structure ship) position (get-resource-by-name block-name))))
